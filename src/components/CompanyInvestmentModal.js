...
const CompanyInvestmentModal = ({ investment, onClose }) => {
  const company = {
    id: "9b43d01f-6e70-431d-a852-cc30ba51c4d57",
    name: '프리딕션',
    category: 'EDUTECH',
    imageUrl: 'https://logo-resources.thevc.kr/organizations/200x200/93831775af8ee45f7ec2eedb5db6e70dde1a2755872df4a1dc2dc63488c40eb4_1616940335687446.jpg',
  };
